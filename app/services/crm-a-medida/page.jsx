    ...
    <main className="bg-white text-gray-900 font-sans">
      ...
      <section className="py-24 px-6 md:px-16 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-10 text-center">
          {[
            {
              icon: <FaServer size={40} className="text-blue-600 mx-auto mb-4" />,
              title: "Middlewares Escalables",
              desc: "Aplicaciones intermedias en Node.js o Python que conectan servicios desacoplados con lógica de negocio y control total.",
            },
            {
              icon: <FaCodeBranch size={40} className="text-blue-600 mx-auto mb-4" />,
              title: "APIs RESTful & Webhooks",
              desc: "Diseño y consumo de APIs externas e internas. Conexión fluida entre CRMs, ERPs, ecommerce y plataformas SaaS.",
            },
            {
              icon: <FaLock size={40} className="text-blue-600 mx-auto mb-4" />,
              title: "Seguridad y Logs",
              desc: "Autenticación OAuth, tokenización, manejo de errores, encriptación y auditoría mediante logs y dashboards técnicos.",
            },
            {
              icon: <FaProjectDiagram size={40} className="text-blue-600 mx-auto mb-4" />,
              title: "Integración Modular",
              desc: "Arquitecturas desacopladas que permiten agregar o reemplazar sistemas sin rehacer la base de tu operación digital.",
            },
          ].map((item, idx) => (
            <motion.div
              key={idx}
      ...
      <section className="py-20 text-center bg-gradient-to-r from-blue-50 to-white">
        <div className="max-w-3xl mx-auto px-6">
          <p className="text-lg text-gray-700">
            Si tu operación necesita hablar entre sistemas, nosotros escribimos el lenguaje.  
            <br />Infraestructura sólida, procesos automatizados, y datos en tiempo real.
          </p>
        </div>
      </section>
    </main>
